    ...
    <>
      ...
      <div className="mt-8">
        ...
        <Card className="mb-4">
          ...
          <CardContent>
            <Progress
              value={(spendLimit.currentSpend / spendLimit.monthlyLimit) * 100}
              className="mb-2"
            />
            <div className="flex justify-between items-center">
              <span>
                ${spendLimit.currentSpend.toFixed(2)} of $
                {spendLimit.monthlyLimit.toFixed(2)}
              </span>
              <Button variant="outline" onClick={handleChangeLimit}>
                Change Limit
              </Button>
            </div>
            <p className="text-sm text-gray-500 mt-2">
              Resets on {spendLimit.resetDate}
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <Button className="mt-2" onClick={handleAddNotification}>
              Add notification
            </Button>
          </CardContent>
        </Card>
