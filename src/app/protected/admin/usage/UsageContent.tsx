    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <Card>
          ...
          <CardContent>
            <div className="text-4xl font-bold">{usageData.totalTokensIn.toLocaleString()}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <div className="text-4xl font-bold">{usageData.totalTokensOut.toLocaleString()}</div>
          </CardContent>
        </Card>
      </div>
      <Card>
